...
class _HomescreenState extends State<Homescreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(187, 86, 205, 249),
        centerTitle: true,
        title: Text(
      ...
      backgroundColor: Color.fromRGBO(244, 201, 241, 1),
      body: Column(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color.fromARGB(187, 86, 205, 249),
                ...
                Transform.translate(
                  ...
                  child: Container(
                    ...
                    height: 190,
                    decoration: BoxDecoration(
                        color: Color.fromRGBO(244, 201, 241, 1),
